 ...
 *
 * Administrative MFA Step-Up and Session Persistence Manager
 *
 * Persists verified admin MFA sessions across tabs and refreshes within the
 * 30-minute validity window. Destructive / high-risk admin actions require that
 * the last verification occurred within 15 minutes.
 */
