...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  navbar: {
    ...
    navTabs: [
      ...
      { id: 'products', label: 'Artisan Catalog', arabicLabel: 'المنتجات' },
      { id: 'offers', label: 'Special Offers', arabicLabel: 'العروض' },
      { id: 'news', label: 'Craft Press & News', arabicLabel: 'الأخبار' },
      { id: 'account', label: 'My Account', arabicLabel: 'حسابي' },
      { id: 'admin', label: 'Artisan Portal', arabicLabel: 'إدارة' },
    ]
  },
  hero: {
