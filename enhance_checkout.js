...
content = content.replace(
  ...
  '<span className="font-mono font-bold text-[#b89753] bg-amber-50 px-3 py-1 rounded-lg border border-amber-200 inline-block mt-1">'
);
...
content = content.replace(/text-\[\#1a1a2e\]/g, 'text-white');
content = content.replace(/<span className="flex items-center justify-center w-6 h-6 rounded-full bg-\[\#c5a059\] text-white text-xs font-black">/g, '<span className="flex items-center justify-center w-6 h-6 rounded-full bg-slate-900 text-white text-xs font-black">');
...
content = content.replace(/'bg-\[\#c5a059\] text-white'/g, "'bg-slate-900 text-white'");
content = content.replace(
...
content = content.replace(/text-white/g, 'text-slate-900'); // for "Total Amount Due"
...
content = content.replace(
  'className="w-full py-4 rounded-xl bg-[#c5a059] hover:bg-[#d4b36e] text-slate-900 font-black uppercase text-xs tracking-widest shadow-xl transition-all cursor-pointer flex items-center justify-center gap-2"',
...
console.log("Updated CheckoutView.tsx");
